...
let myName = prompt("Please enter your name","Unkown User");
let myVideoStream;
...
const sidebar = () => {
  document.querySelector('.right').classList.toggle('disappear');
  document.querySelector('.left').classList.toggle('left_size');
}